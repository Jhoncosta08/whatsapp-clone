    ...
    initAuth() {
        this._firebase.initAuth().then(response => {
            ...
            this._user.on('datachange', data => {
                document.querySelector('title').innerHTML = data.name + ' - connected';
    ...
    initEvents(){
        ...
        this.el.inputDocument.on('change', e => {
            if(this.el.inputDocument.files.length) {
                ...
                this._documentPreviewControlle = new DocumentPreviewController(file);
                this._documentPreviewControlle.getPreviewData().then(result => {
        ...
        this.el.btnAttachContact.on('click', e => {
            this._contactsContoller = new ContactsController(this.el.modalContacts, this._user);
